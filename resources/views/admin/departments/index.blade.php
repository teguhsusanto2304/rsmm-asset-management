        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col gap-4 mb-4">
                ...
                <div class="flex items-center gap-2 text-sm">
                    ...
                    <span class="text-[#111518] font-medium">Master Data: Departemen</span>
                </div>

                {{-- Title --}}
                <div class="flex justify-between items-end">
                    <div>
                        <h2 class="text-3xl font-black text-[#111518]">Master Data: Departemen</h2>
                        <p class="text-[#617989]">
                ...
                <div class="p-2 overflow-y-auto">
                    <ul class="space-y-1 text-sm">
                        @foreach ($departments as $dept)
                            @include('admin.departments.partials.tree', ['department' => $dept])
                        @endforeach
                    </ul>
                </div>
            </aside>
                ...
                <div class="p-4 border-b flex justify-between items-center">
                    <div>
                        <h3 class="font-bold text-lg">
                            {{ optional($selectedDepartment)->department ?? 'Pilih Departemen' }}
                        </h3>
                                ...
                                <tr class="hover:bg-[#f8fbff]">
                                    ...
                                    <td class="p-4 text-right">
                                        <div class="flex justify-end gap-2">
                                            <a href="{{ route('departments.edit', $unit) }}"
                                               class="text-primary hover:bg-primary/10 p-1 rounded">
                                                <span class="material-symbols-outlined">edit</span>
                                            </a>
                                            <form method="POST"
                                                  action="{{ route('departments.destroy', $unit) }}">
                                                @csrf @method('DELETE')
                                                <button
